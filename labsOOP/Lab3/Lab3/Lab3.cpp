...
int main()
{
    ...
    p:;
        ...
        cin >> orchestraSalary;
        Apartment apartament = Apartment(apartamentName, apartamentAdress, rentCost, amountOfSeats);
    ...
    p2:;
        ...
        Performance perfomance(perfomanceName, category, apartament, troupeName, amountOfActors, troupeSalary, date, rent, _orchestra);

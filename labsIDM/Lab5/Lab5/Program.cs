...
double[,] resultTestData = Lab5.Lab5Things.GetDataFromFile("Training2.txt", amountOfNodes[0] + amountOfNodes[^1]);
string FileName = "Result1.txt"; 
//Lab5.SearchBestHyperparamets.main(amountOfNodes, learningData, resultTestData, FileName);
Lab5.Results.main(amountOfNodes, learningData, resultTestData, FileName);
